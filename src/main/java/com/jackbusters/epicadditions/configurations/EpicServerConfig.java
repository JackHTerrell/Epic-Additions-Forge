...
public class EpicServerConfig {
    ...
    static {
        ...
        severedWitherSkullCoolDown = BUILDER.comment("The amount of time the cooldown on the Severed Wither Skull lasts.").defineInRange("severedWitherSkullCoolDown", 7, 0, 90);
        masteredDragonHeadCoolDown = BUILDER.comment("The amount of time the cooldown on the Mastered Dragon Head lasts.").defineInRange("masteredDragonHeadCoolDown", 7, 0, 90);
